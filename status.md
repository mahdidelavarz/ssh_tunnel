# Germany Server - Sat May  9 10:30:13 UTC 2026

## Command: echo 51.75.0.0/24 | sudo tee -a /root/iran-spoof-test.txt
```
...
debug1: Sending command: echo 51.75.0.0/24 | sudo tee -a /root/iran-spoof-test.txt
debug1: pledge: fork
51.75.0.0/24
...
Bytes per second: sent 3179.6, received 3480.3
