# Germany Server - Sat May  9 10:30:55 UTC 2026

## Command: sudo cat /root/iran-spoof-test.txt
```
...
debug1: Sending command: sudo cat /root/iran-spoof-test.txt
debug1: pledge: fork
5.9.0.0/24
138.68.0.0/24
51.75.0.0/24
...
Transferred: sent 3240, received 3588 bytes, in 0.5 seconds
Bytes per second: sent 6082.4, received 6735.7
