# Germany Server - Sat May  9 10:32:40 UTC 2026

## Command: echo 217.219.0.0/24 | sudo tee -a /root/iran-spoof-test.txt
```
...
debug1: Sending command: echo 217.219.0.0/24 | sudo tee -a /root/iran-spoof-test.txt
debug1: pledge: fork
217.219.0.0/24
...
Bytes per second: sent 3347.8, received 3655.5
