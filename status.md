# Germany Server - Sat May  9 13:43:00 UTC 2026

## Command: cd ./temp_repo && ls -la
```
...
debug1: Sending command: cd ./temp_repo && ls -la
debug1: pledge: fork
total 56620
...
Transferred: sent 3224, received 3908 bytes, in 1.0 seconds
Bytes per second: sent 3344.8, received 4054.4
