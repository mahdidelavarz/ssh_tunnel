# Germany Server - Sat May  9 10:28:46 UTC 2026

## Command: echo 5.9.0.0/24 | sudo tee /root/iran-spoof-test.txt
```
...
debug1: Sending command: echo 5.9.0.0/24 | sudo tee /root/iran-spoof-test.txt
debug1: pledge: fork
5.9.0.0/24
...
Bytes per second: sent 3105.2, received 3398.9
